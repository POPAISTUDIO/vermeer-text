...
- **Code natif LibreChat modifié — watchlist merge upstream**. À chaque merge depuis upstream LibreChat, contrôler ces 12 fichiers en priorité, car nous y avons ajouté du code Vermeer susceptible de conflit :
